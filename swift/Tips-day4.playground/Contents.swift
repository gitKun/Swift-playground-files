...
/*
 对 URL 进行处理是，如果 URL 中有需要保留的字符，如 # ，则可以在如下处理
 */
let urlString = "http://10.0.3.86/中文/main.html#/help"
// 编码
var charSet = CharacterSet.urlQueryAllowed
charSet.insert("#")
let encodedString = urlString.addingPercentEncoding(withAllowedCharacters: charSet)
//"http://10.0.3.86/%E4%B8%AD%E6%96%87/main.html#/help"



class MyClassOne<T: Collection> {
    var counter: T
    init(counter: T) {
...
let cls = MyClassOne(counter: [1, 2, 3])
print(cls.counter)


func sortStr(str: String) -> String {
    // let sorted: [String.Element] = str.sorted()  1. sorted() -> [Character]; 2. typealias Element = Character
